...
const Header: React.FC<HeaderProps> = ({ inputComponent }) => {
  ...
  return (
    <>
          ...
          <Sheet open={isCartOpen} onOpenChange={setIsCartOpen}>
            <SheetTrigger asChild>
              ...
              >
                <ShoppingBagIcon />
                {products.length > 0 && (
                  <span className="absolute right-0 top-0 flex h-[14px] w-[14px] items-center justify-center rounded-full bg-primary text-[9px] text-white">
                    {products.length}
                  </span>
                )}
              </Button>
              ...
              {data?.user ? (
                ...
                <>
                  <div className="mt-6 flex items-center justify-between">
                    <h3 className="font-semibold">Faça o seu login!</h3>
                    <Button
                      size="icon"
      ...
      <div onClick={() => setIsConfirmDialogOpen(false)}>
        ...
        >
          <AlertDialogContent className="w-2/3 rounded-xl">
            <AlertDialogHeader>
              <AlertDialogTitle>Faça o login na plataforma!</AlertDialogTitle>
              <AlertDialogDescription>
      ...
      <div onClick={() => setLogOutDialogOpen(false)}>
